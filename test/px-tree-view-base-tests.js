...
function runBaseTests() {
  px_tree_view = document.getElementById('px-tree');

  suite('Base Automation Tests for px-tree', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-tree fixture is created', function() {
      assert.isTrue(document.getElementById('px-tree') !== null);
    });
