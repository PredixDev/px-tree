...
function runBaseTests() {
  px_tree_view = document.getElementById('px-tree-view');

  suite('Base Automation Tests for px-tree-view', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-tree-view fixture is created', function() {
      assert.isTrue(document.getElementById('px-tree-view') !== null);
    });
